package com.normalone.tutorialmod.world.tree.custom;
                ...
                if (random.nextFloat() > 0.25f) {
                    for (int x = 1; x <= 4; x++) {
                        replacer.accept(startPos.up(i).offset(Direction.NORTH, x), ((BlockState) Function.identity().apply(config.trunkProvider
                                .get(random, startPos.up(i).offset(Direction.NORTH)).with(PillarBlock.AXIS, Direction.Axis.Z))));
                    }
                }
                ...
                if (random.nextFloat() > 0.25f) {
                    for (int x = 1; x <= 4; x++) {
                        replacer.accept(startPos.up(i).offset(Direction.SOUTH, x), ((BlockState) Function.identity().apply(config.trunkProvider
                                .get(random, startPos.up(i).offset(Direction.SOUTH)).with(PillarBlock.AXIS, Direction.Axis.Z))));
                    }
                }
                ...
                if (random.nextFloat() > 0.25f) {
                    for (int x = 1; x <= 4; x++) {
                        replacer.accept(startPos.up(i).offset(Direction.WEST, x), ((BlockState) Function.identity().apply(config.trunkProvider
                                .get(random, startPos.up(i).offset(Direction.WEST)).with(PillarBlock.AXIS, Direction.Axis.X))));
                    }
                }
                ...
                if (random.nextFloat() > 0.25f) {
                    for (int x = 1; x <= 4; x++) {
                        replacer.accept(startPos.up(i).offset(Direction.EAST, x), ((BlockState) Function.identity().apply(config.trunkProvider
                                .get(random, startPos.up(i).offset(Direction.EAST)).with(PillarBlock.AXIS, Direction.Axis.X))));
                    }
                }
            }
        }
